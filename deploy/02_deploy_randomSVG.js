...
module.exports = async ({
  ...
  if (chainId != 31337) {
    ...
    let vrf_tx = await vrfCoordinator.callBackWithRandomness(receipt.logs[3].topics[1], 77779, randomSVG.address);
    await vrf_tx.wait(1);
    log("Now lets finish the mint!");
    let finish_tx = await randomSVG.finishMint(tokenId, { gasLimit: 3000000 });
